...
(after! lsp
  (setq lsp-cmake-server-command "neocmakelsp stdio"))
#+end_src
...
(after! org
  (defun my/org-inherited-priority (s)
    (cond
     ...
     ((string-match org-priority-regexp s)
               (- 1000 (org-priority-to-value (match-string 2 s))))
     ;; No priority cookie, but already at highest level
     ((not (org-up-heading-safe))
      (- 1000 (or org-default-priority 67)))
  ...
  (setq visual-line-mode t
        ...
        org-priority-faces '((65 . error) (66 . nerd-icons-yellow) (67 . success) (68 . nerd-icons-cyan) (69 . shadow))
...
#+begin_src emacs-lisp
(setq org-agenda-files (list org-directory (concat org-directory "uni")))
(after! org
...
Uses a property (SPACED_N) to track repetition count."
  (let* ((spaced-rep-map '((0 . "++0d")
                           (1 . "++1d")
                           (2 . "++2d")
                           (3 . "++3d")
                           (4 . "++7d")
                           ...
                           (6 . "++30d")
                           (7 . "++2m")))
         (spaced-key "SR") ; still use tag "SR" as marker
         (tags (org-get-tags nil t))
         (spaced-todo-p (member spaced-key tags))
         (prop-name "SPACED_N")
         (repetition-n (string-to-number (or (org-entry-get nil prop-name) "0")))
         (n+1 (1+ repetition-n))
         (spaced-repetition-p (alist-get n+1 spaced-rep-map)))
    (when (and spaced-todo-p spaced-repetition-p)
      ...
      ;; update repetition property
      (org-entry-put nil prop-name (number-to-string n+1))
